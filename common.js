(function ($, undefined) {
  $(function () {
    ...
    // height fot text-box
    var boxHeight = $('#portfolio').find('.image-box').innerHeight();
    console.log(boxHeight)
    $('#portfolio').find('.text-box').each(function () {
...
GravityPoint.prototype = (function (o) {
  ...
  _draw: function (ctx) {
    ...
    grd.addColorStop(1, Math.random() < 0.2 ? 'rgba(255, 255, 255, 0.15)' : 'rgba(255, 255, 255, 0.75)');
    ctx.beginPath();
